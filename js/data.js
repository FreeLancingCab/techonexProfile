const CompanyData = {
  ...
  catalogs: [
    ...
    {
      id: "coldspell-catalog",
      title: "Technoex Coldspell Refrigerated Dryer Catalogue",
      subtitle: "Refrigerated Air Drying Systems",
      description: "Thermal performance data for <strong class='text-[#0077C8]'>Technoex Coldspell</strong> refrigerated air dryers including condenser specifications, ambient temperature operating ranges, refrigerant charge tables, and condensate drain capacity charts.",
      filename: "coldspell_refrigerated_dryer_catalogue.pdf",
      version: "2026.1",
      fileSize: "2.8 MB",
      pageCount: 3,
    ...
    {
      id: "hitachi-oilfree-catalog",
      title: "Technoex Hitachi Oil Free Compressor Catalogue",
      subtitle: "Class 0 Certified Oil-Free Systems",
      description: "Certification and performance data for <strong class='text-[#0077C8]'>Hitachi Oil Free</strong> compressors including ISO 8573-1 Class 0 compliance reports, air purity certifications, bearing life calculations, and energy efficiency curves.",
      filename: "hitachi_oil_free_compressor_catalogue.pdf",
      version: "2026.1",
      fileSize: "5.1 MB",
      pageCount: 6,
      ...
      file: "",
      downloadUrl: "",
      gradient: "from-[#1B5E20] via-[#0a2e0c] to-slate-900",
      accent: "#4CAF50",
      icon: "compressor"
    },
    {
      id: "scroll-compressor-catalog",
      title: "Technoex Scroll Compressor Catalogue",
      subtitle: "Ultra-Quiet Scroll Compression Technology",
      description: "Acoustic and thermodynamic data for <strong class='text-[#0077C8]'>Technoex Scroll Compressors</strong> including sound power level measurements, suction/discharge pressure ratios, volumetric efficiency maps, and vibration analysis reports.",
      filename: "scroll_compressor_catalogue.pdf",
      version: "2026.1",
      fileSize: "3.4 MB",
      pageCount: 4,
      releaseDate: "May 2026",
    ...
    {
      id: "hitachi-ups-catalog",
      title: "Technoex Hitachi Hi-Rel Online UPS Catalogue",
      subtitle: "Double-Conversion Online UPS Systems",
      description: "Electrical specifications for <strong class='text-[#0077C8]'>Hitachi Hi-Rel Online UPS</strong> systems including double-conversion topology diagrams, input power factor data, battery autonomy calculators, and parallel redundancy configurations.",
      filename: "hitachi_hirel_online_ups_catalogue.pdf",
      version: "2026.1",
      fileSize: "8.2 MB",
      pageCount: 8,
      releaseDate: "March 2026",
    ...
    {
      id: "uniline-stabilizer-catalog",
      title: "Technoex Uniline Servo Stabilizer Catalogue",
      subtitle: "Servo-Operated Voltage Stabilizers",
      description: "Voltage regulation data for <strong class='text-[#0077C8]'>Uniline Servo Stabilizers</strong> including input/output voltage windows, correction speed specifications, buck-boost transformer ratings, and overload trip characteristics.",
      filename: "uniline_servo_stabilizer_catalogue.pdf",
      version: "2026.1",
      fileSize: "4.5 MB",
      pageCount: 5,
      releaseDate: "April 2026",
    ...
    {
      id: "rotary-vane-catalog",
      title: "Technoex Rotary Vane Vacuum Pump Catalogue",
      subtitle: "Industrial Vacuum Generation Systems",
      description: "Vacuum performance curves for <strong class='text-[#0077C8]'>Technoex Rotary Vane Vacuum Pumps</strong> including ultimate pressure specifications, pumping speed at various pressures, oil consumption rates, and gas ballast valve sizing data.",
      filename: "rotary_vane_vacuum_pump_catalogue.pdf",
      version: "2026.1",
      fileSize: "3.1 MB",
      pageCount: 3,
      releaseDate: "February 2026",
      file: "",
      downloadUrl: "",
      gradient: "from-[#BF360C] via-[#4a1400] to-slate-900",
      accent: "#DD2C00",
      icon: "vacuum"
    },
    {
      id: "oil-water-separator-catalog",
      title: "Technoex Oil Water Separator Catalogue",
      subtitle: "Condensate Treatment & Environmental Compliance",
      description: "Environmental compliance specifications for <strong class='text-[#0077C8]'>Technoex Oil Water Separators</strong> including oil content residual measurements, filtration stages, condensate flow capacity, and discharge quality certificates.",
      filename: "oil_water_separator_catalogue.pdf",
      version: "2026.1",
      fileSize: "2.4 MB",
      pageCount: 2,
      releaseDate: "June 2026",
    ...
    {
      id: "air-receiver-catalog",
      title: "Technoex Air Receiver Tank Catalogue",
      subtitle: "Compressed Air Storage & Pulsation Dampening",
      description: "Pressure vessel specifications for <strong class='text-[#0077C8]'>Technoex Air Receiver Tanks</strong> including ASME/PED certification data, maximum allowable working pressures, volumetric capacity charts, and safety valve sizing calculations.",
      filename: "air_receiver_tank_catalogue.pdf",
      version: "2026.1",
      fileSize: "1.9 MB",
      pageCount: 2,
      ...
      file: "",
      downloadUrl: "",
      gradient: "from-[#37474F] via-[#101a20] to-slate-900",
      accent: "#78909C",
      icon: "accessories"
    },
    {
      id: "filter-elements-catalog",
      title: "Technoex Compressor Filter Elements Catalogue",
      subtitle: "OEM-Grade Filtration Replacement Parts",
      description: "Filtration efficiency data for <strong class='text-[#0077C8]'>Technoex Filter Elements</strong> including air intake filter specs, oil filter micron ratings, separator element replacement intervals, and pressure drop vs. flow curves.",
      filename: "compressor_filter_elements_catalogue.pdf",
      version: "2026.1",
      fileSize: "2.7 MB",
      pageCount: 3,
      releaseDate: "March 2026",
      file: "",
      downloadUrl: "",
      gradient: "from-[#F57F17] via-[#4a2400] to-slate-900",
      accent: "#FFC107",
      icon: "accessories"
    },
    {
