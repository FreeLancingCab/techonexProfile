const CompanyData = {
  ...
  products: [
    ...
    { id: "comp-3", name: "Industrial Air Compressor", category: "Air Compressor", shortDescription: "Reliable medium-pressure compressor for plant installations.", brand: "Technoex", price: "Request Quote", image: "assets/complogo.png", specifications: ["Designed for 24/7 continuous operation", "Dual belt-drive system", "Vibration isolator mounts"], features: ["High volume delivery", "Easy filter access", "Thermal overload protection"] },
    { id: "comp-4", name: "Reciprocating Air Compressor", category: "Air Compressor", shortDescription: "Multi-stage compression piston block for high pressures.", brand: "Technoex", price: "Request Quote", image: "assets/complogo.png", specifications: ["Splash lubricated compressor pump", "Heavy duty intake air filters", "ASME coded air receiver tanks"], features: ["Excellent cooling fins", "Low noise valves", "Long maintenance loops"] },
    ...
    { id: "comp-10", name: "H-Series Piston Air Compressor", category: "Air Compressor", shortDescription: "High-pressure piston compressor for industrial molding.", brand: "Technoex", price: "Request Quote", image: "assets/complogo.png", specifications: ["Reinforced crankshaft assemblies", "Water-cooled cylinder sleeves", "Automatic unloading startup"], features: ["Designed for high output pressure", "Heavy-gauge steel base", "Dual safety check valves"] },
