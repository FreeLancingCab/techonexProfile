        ...
        <div class="relative z-10">
          ...
          <div class="flex justify-center mb-8 md:mb-12">
            <div class="flex h-[38px] text-[14px] text-white/60">
              ...
              <div class="text-[#f4f4f5] select-none cursor-default px-3 py-1 rounded-r-lg border-y border-r border-r-white/10 border-y-white/10 flex items-center bg-[#09090b]">
                .PDF
              </div>
            </div>
          </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 items-start">
            ...
            <div class="flex flex-col items-center pt-4 md:pt-8">
              <div class="card scale-[0.85] sm:scale-90 md:scale-100 origin-top">
                <button class="mail" onclick="const isMobile = /Android|iPhone|iPad|iPod|webOS|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent); if(isMobile){window.location.href='tel:+919599885546';}else{window.open('https://mail.google.com/mail/?view=cm&fs=1&to=technoex.sales@gmail.com','_blank');}">
                ...
                <div class="bottom">
                  <div class="content">
                    <span class="name">Nishtha Sharma</span>
                    <span class="about-me">Business Development Manager – Technoex</span>
                    <p class="about-hover-text">As the Business Development Manager at Techonex, I lead business operations across the medical sector, driving client acquisition, strategic partnerships, and end-to-end project coordination. I oversee cross-functional workflows, manage key business decisions, and ensure smooth operational execution. Acting as the second-in-command, I handle critical company operations and maintain business continuity whenever the Managing Director is unavailable.</p>
                  </div>
                  <div class="bottom-bottom">
                    <div class="social-links-container">
                      <a href="https://www.instagram.com/technoex.nishtha?igsh=MXVteGowMzg0bHF5Zg==" target="_blank" rel="noopener noreferrer">
                      ...
                      <a href="https://www.linkedin.com/in/nishtha-sharma-222505380?utm_source=share_via&utm_content=profile&utm_medium=member_android" target="_blank" rel="noopener noreferrer">
                        <img src="assets/linkedin-logo.png" alt="LinkedIn" />
                      </a>
                      <a href="https://mail.google.com/mail/?view=cm&fs=1&to=technoex.sales@gmail.com" target="_blank" onclick="event.preventDefault(); const isMobile = /Android|iPhone|iPad|iPod|webOS|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent); if(isMobile){window.location.href='tel:+919599885546';}else{window.open('https://mail.google.com/mail/?view=cm&fs=1&to=technoex.sales@gmail.com','_blank');}">
                        <img src="assets/gmail.png" alt="Gmail" />
                      </a>
                    </div>
                    <button class="button" onclick="const isMobile = /Android|iPhone|iPad|iPod|webOS|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent); if(isMobile){window.location.href='tel:+919599885546';}else{window.open('https://mail.google.com/mail/?view=cm&fs=1&to=technoex.sales@gmail.com','_blank');}">Contact Me</button>
                  </div>
                </div>
              </div>
      ...
      body.innerHTML = `
        <div class="md:w-1/2 flex flex-col text-slate-800 p-4 sm:p-6">
          ...
          <div class="mt-auto pt-4 sm:pt-6">
            ...
            <a href="https://mail.google.com/mail/?view=cm&fs=1&to=technoex.sales@gmail.com" class="request-quote-btn" target="_blank" onclick="event.preventDefault(); const isMobile = /Android|iPhone|iPad|iPod|webOS|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent); if(isMobile){window.location.href='tel:+919599885546';}else{window.open('https://mail.google.com/mail/?view=cm&fs=1&to=technoex.sales@gmail.com','_blank');}">
              Request Quote
            </a>
          </div>
        </div>
        ...
        <div class="md:w-1/2 flex flex-col gap-3 sm:gap-4 p-4 sm:p-6">
          ...
          <div class="mt-auto pt-4 sm:pt-5">
            <a href="https://mail.google.com/mail/?view=cm&fs=1&to=technoex.sales@gmail.com" class="enquiry-btn" target="_blank" onclick="event.preventDefault(); const isMobile = /Android|iPhone|iPad|iPod|webOS|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent); if(isMobile){window.location.href='tel:+919599885546';}else{window.open('https://mail.google.com/mail/?view=cm&fs=1&to=technoex.sales@gmail.com','_blank');}">
              Enquiry Now
            </a>
          </div>
        </div>
