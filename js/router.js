        ...
        if (shuffleGrid && typeof ShuffleHero !== 'undefined') {
          AppRouter.routes.home._shuffleHero = new ShuffleHero(shuffleGrid, {
            images: [
              ...
              { id: 5, src: "assets/ins5.jpeg" },
              { id: 6, src: "assets/Ins6.jpeg" },
              { id: 7, src: "assets/Ins7.jpeg" },
              { id: 8, src: "assets/Ins8.jpeg" },
              { id: 9, src: "assets/Ins9.jpeg" },
              { id: 10, src: "assets/Ins10.jpeg" },
              { id: 11, src: "assets/Ins11.jpeg" },
              { id: 12, src: "assets/Ins12.jpeg" },
              { id: 13, src: "assets/Ins13.jpeg" },
              { id: 14, src: "assets/Ins14.jpeg" },
              { id: 15, src: "assets/Ins15.jpeg" },
              { id: 16, src: "assets/Ins16.jpeg" }
            ],
            interval: 3000,
            cols: 4,
            rows: 4
